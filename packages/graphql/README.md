...
Generate API reference docs from GraphQL schemas for [Chrona](https://chrona.dev), with an interactive playground.

```bash
npm i @chrona/graphql graphql
```
...
```css
@import '@chrona/graphql/css/preset.css';
```
...
See [Chrona docs](https://chrona.dev) for more.
