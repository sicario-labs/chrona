...
import {
  ...
  Accordions,
  AccordionTrigger,
} from '@chrona/api-docs/components/accordion';
import { cn } from '@/utils/cn';
import { SelectTabs, SelectTabTrigger, SelectTab } from '@chrona/api-docs/components/select-tab';
import { AnchorSection } from '@chrona/api-docs/auto-anchor/client';
...
export function Operation({
  ...
  const operation = useMemo(() => {
    ...
    if (!operation) throw new Error(`[Chrona AsyncAPI] Operation not found in schema: ${id}`);
