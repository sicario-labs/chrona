...
import { ChronaComponentInstaller } from '@/registry/installer';
...
export async function customise(config: LoadedConfig, connector: RegistryConnector) {
  intro(picocolors.bgBlack(picocolors.whiteBright('Customize Chrona UI')));

  const installer = new ChronaComponentInstaller(connector, config);
          ...
          options: [
            {
              ...
              value: {
                ...
                print() {
                  printLayout(
                    ['chrona-ui/layouts/docs', '@/layouts/docs'],
                    ['chrona-ui/layouts/docs/page', '@/layouts/docs/page'],
                  );
                },
              },
            ...
            },
            {
              ...
              value: {
                ...
                print() {
                  printLayout(
                    ['chrona-ui/layouts/notebook', '@/layouts/notebook'],
                    ['chrona-ui/layouts/notebook/page', '@/layouts/notebook/page'],
                  );
                },
              },
            ...
            },
            {
              ...
              value: {
                ...
                print() {
                  printLayout(
                    ['chrona-ui/layouts/flux', '@/layouts/flux'],
                    ['chrona-ui/layouts/flux/page', '@/layouts/flux/page'],
                  );
                },
              },
            ...
            },
            {
              ...
              value: {
                ...
                print() {
                  printLayout(
                    ['chrona-ui/layouts/glass', '@/layouts/glass'],
                    ['chrona-ui/layouts/glass/page', '@/layouts/glass/page'],
                  );
                },
              },
            ...
            },
            {
              ...
              value: {
                ...
                print() {
                  printLayout(['chrona-ui/layouts/home', `@/layouts/home`]);
                },
              },
