...
/**
 * This transformer **must** be used with the `rehype-code` plugin of Chrona.
 */
        ...
        code: (state, node: Code) => {
          ...
          try {
            ...
            if (e instanceof Error) {
              console.error(
                `[chrona-twoslash] encountered an error when highlighting codeblock in a Twoslash popup: ${e.message}`,
              );
            }
