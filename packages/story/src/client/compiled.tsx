...
export interface StoryOptions<C extends FC<any>> {
  ...
  /**
   * Controls & data generated at build time by `@chrona/story/vite` or `@chrona/story/next`.
   *
   * @internal
   */
  _generated?: {
        ...
        return {
          ...
          presets: normalized.map((preset) => {
            ...
            if (preset.controls && 'node' in preset.controls) {
              ...
              throw new Error(
                `[@chrona/story] No generated data for story, make sure the Vite plugin or Turbopack loader is configured correctly`,
              );
            }
