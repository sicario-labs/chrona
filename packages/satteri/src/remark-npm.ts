...
import { generateCodeBlockTabs } from 'chrona-core/mdx-plugins/codeblock-utils';
import type { CodeBlockTabsOptions } from 'chrona-core/mdx-plugins/codeblock-utils';
