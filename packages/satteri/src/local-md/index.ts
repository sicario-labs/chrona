import type { MetaData, DynamicSource, StaticSource } from 'chrona-core/source';
import type { StandardSchemaV1 } from '@standard-schema/spec';
import {
  createLocalSource,
  type SourceOptions,
  type WatchableSource,
} from '@chrona/local-content';
import { markdownIntegration, type MarkdownPage } from './integration';
import type * as defaultSchemas from 'chrona-core/source/schema';
...
> extends WatchableSource {
   ...
   * `watchWithVite()` from `@chrona/local-content/dev/vite`.
   */
