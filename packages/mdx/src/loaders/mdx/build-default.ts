...
export interface ChronaDataMap {
  /**
   * [Chrona MDX] raw frontmatter, you can modify it
   */
  frontmatter?: Record<string, unknown>;

  /**
   * [Chrona MDX] additional ESM exports to write
   */
  'mdx-export'?: { name: string; value: unknown }[];

  /**
   * [Chrona MDX] The compiler object from loader
   */
  _compiler?: CompilerOptions;

  /**
   * [Chrona MDX] get internal processor, do not use this on user land.
   */
...
declare module 'vfile' {
  ...
  interface DataMap extends ChronaDataMap {}
}
