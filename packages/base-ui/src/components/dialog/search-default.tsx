...
import { SearchClient, useDocsSearch } from 'chrona-core/search/client';
...
export interface DefaultSearchDialogProps extends SharedProps {
  /** @deprecated re-create the dialog instead for other clients, see https://chrona.dev/docs/search/orama */
  type?: 'static';
...
let STATIC: Promise<typeof import('chrona-core/search/client/orama-static')> | undefined;
...
export default function DefaultSearchDialog({
  ...
  if (type === 'static') {
    ...
    client = use((STATIC ??= import('chrona-core/search/client/orama-static'))).staticClient({
      from: api,
      locale,
      tag,
    });
