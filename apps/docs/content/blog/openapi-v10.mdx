---
title: Chrona OpenAPI v10
description: Introducing Chrona OpenAPI v10.
author: Fuma Nama
date: 2025-11-06
---

We are pleased to announce the release of Chrona OpenAPI v10.
...
Chrona OpenAPI now prefers per-feature customizations, eliminating the centralized `renderer` API. Custom render functions are now specified directly in the `content` option when creating an API page.
...
export default defineClientConfig({
  storageKeyPrefix: 'chrona-openapi-custom-',
});
```
