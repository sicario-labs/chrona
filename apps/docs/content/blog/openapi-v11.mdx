---
title: Chrona OpenAPI v11
description: Upgrade guide for Chrona OpenAPI v11.
author: Fuma Nama
date: 2026-06-11
---

We are pleased to announce the release of Chrona OpenAPI v11.
...
If you haven't migrated to v10 yet, read the [Chrona OpenAPI v10](/blog/openapi-v10) announcement first.
...
The `chrona-openapi/ui/client` subpath export is removed. Merge any `defineClientConfig()` options into `createOpenAPIPage()` directly.

```tsx tab="Before" title="components/api-page.tsx"
import { openapi } from '@/lib/openapi';
import { createAPIPage } from 'chrona-openapi/ui';
...
'use client';
import { defineClientConfig } from 'chrona-openapi/ui/client';
...
```tsx tab="Before"
import { createCodeSample } from 'chrona-openapi/server';
...
import { transformerOpenAPI } from 'chrona-openapi/server';
