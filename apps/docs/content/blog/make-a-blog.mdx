---
title: Making a Blog with Chrona
description: Chrona + Blog
author: Fuma Nama
date: 2024-12-15
---

Chrona is a docs framework, but it's also a powerful tool to manage content in Next.js. You can use Chrona to build a blog site along with docs, on a single Next.js app.

## Overview

This guide helps you build a blog site with Chrona and Chrona MDX.

We will use Chrona MDX to manage the content, and implement our own UI with Tailwind CSS & Chrona UI.
...
import { defineCollections } from 'chrona-mdx/config';
import { pageSchema } from 'chrona-core/source/schema';
import { z } from 'zod';
...
Colors like `text-fd-muted-foreground` are from the design system of Chrona UI, you may also use your own colors, or use Shadcn UI.
