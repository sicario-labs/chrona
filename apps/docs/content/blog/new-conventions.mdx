...
I love to have fewer files, but considering `create-chrona-app` should also act as a starting point for beginners who may not be familiar with MDX, it's much more helpful to provide it by default.
...
The new [Internationalization](/docs/internationalization) guide requires Chrona 15.2.3 or above.
