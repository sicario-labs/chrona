...
Enable `includeProcessedMarkdown` in your collection config, Chrona MDX runs `remarkLLMs` internally when this is set.

```ts title="source.config.ts"
import { defineDocs } from 'chrona-mdx/config';
import { type LLMsOptions } from 'chrona-core/mdx-plugins/remark-llms';
...
import { remarkLLMs, type LLMsOptions } from 'chrona-core/mdx-plugins/remark-llms';
...
```ts
import { placeholder, type LLMsOptions } from 'chrona-core/mdx-plugins/remark-llms';
...
```ts
import { renderPlaceholder } from 'chrona-core/mdx-plugins/remark-llms.runtime';
...
<auto-type-table
  type="import('chrona-core/mdx-plugins/remark-llms').LLMsOptions"
/>
