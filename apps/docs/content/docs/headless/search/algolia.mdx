...
description: Integrate Algolia Search with Chrona
---
...
import type { DocumentRecord } from 'chrona-core/search/algolia';
...
import { sync, DocumentRecord } from 'chrona-core/search/algolia';
...
- Using [Chrona UI search dialog](/docs/search/algolia).
...
- **Chrona UI**: Enable [Tag Filter](/docs/search/algolia#tag-filter) on Search UI.
