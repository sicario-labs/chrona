...
3. Create a script to sync search indexes.
   ...
   import { sync, type OramaDocument } from 'chrona-core/search/orama-cloud';
...
- Using [Chrona UI search dialog](/docs/search/orama-cloud).
- Custom search UI using the built-in hook of Chrona:
