---
title: Trieve Search
description: Integrate Trieve Search with Chrona
---
...
```package-install
trieve-ts-sdk trieve-chrona-adapter
```
...
import { type TrieveDocument } from 'trieve-chrona-adapter/search/sync';
...
import { sync, type TrieveDocument } from 'trieve-chrona-adapter/search/sync';
...
'use client';
import type { SharedProps } from 'chrona-ui/components/dialog/search';
import SearchDialog from 'trieve-chrona-adapter/components/dialog/search';
import { TrieveSDK } from 'trieve-ts-sdk';
...
```ts
import { TrieveSDK } from 'trieve-ts-sdk';
import { useTrieveSearch } from 'trieve-chrona-adapter/search/trieve';
...
```js
import { sync } from 'trieve-chrona-adapter/search/sync';
import { TrieveSDK } from 'trieve-ts-sdk';
