---
title: Mixedbread
description: Integrate Mixedbread Search with Chrona
---
...
import { createMixedbreadSearchAPI } from 'chrona-core/search/mixedbread';
...
- **Chrona UI**: see [Search UI](/docs/search/mixedbread) for details.
- **Search Client**:
...
- **Chrona UI**: Enable [Tag Filter](/docs/search/mixedbread#tag-filter) on Search UI.
