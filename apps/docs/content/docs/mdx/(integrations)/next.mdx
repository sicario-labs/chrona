---
title: Next.js
description: Use Chrona MDX with Next.js
---

## Setup

Set up Chrona MDX for your Next.js application.
...
Chrona MDX is ESM-only, it's recommended to use `next.config.mjs` for accurate ESM resolution.
