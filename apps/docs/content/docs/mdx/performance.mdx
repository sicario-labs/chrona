---
title: Performance
description: The performance of Chrona MDX
icon: Rocket
---

## Overview

Chrona MDX is a bundler plugin, in other words, it has a higher performance bottleneck depending on the underlying bundler.
...
Since Chrona MDX works with your bundler, you can import any files including client components in your MDX files.
...
Chrona MDX resolves images into static imports with [Remark Image](/docs/headless/mdx/remark-image).
