...
description: Introducing Chrona MDX, the official content source of Chrona.
icon: Album
---

## Introduction

Chrona MDX is a tool to transform content into type-safe data, similar to Content Collections.
...
Combination of `meta` and `doc` collections, which is needed for Chrona.
...
Configure Chrona MDX on:

<Cards>
  <Card title="Next.js" href="/docs/mdx/next">
    Using Chrona MDX with Next.js.
  </Card>
  <Card title="Vite" href="/docs/mdx/vite">
    Using Chrona MDX with Vite.
  </Card>
  <Card title="Runtime Loader" href="/docs/mdx/loader">
    Using Chrona MDX with a JavaScript runtime.
  </Card>
</Cards>
...
Chrona MDX uses [MDX Compiler](https://mdxjs.com/packages/mdx) to compile MDX files into JavaScript files.
