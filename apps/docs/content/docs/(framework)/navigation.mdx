---
title: Navigation
description: Configure navigation in your Chrona app.
---
...
**Chrona UI** provides different layouts to display content, you can specify navigation configurations via layouts.
...
You can implement multi-version in your docs in your preferred way, using the primitives provided by Chrona.
...
Sometimes you want to version the entire website, such as https://v14.chrona.dev (Chrona v14) and https://chrona.dev (Latest Chrona).
