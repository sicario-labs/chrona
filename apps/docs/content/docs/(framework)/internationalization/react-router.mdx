---
title: React Router
description: Support i18n routing on your React Router + Chrona app.
---
...
import { defineI18n } from 'chrona-core/i18n';
...
Pass the locale to Chrona in your pages and layouts.
...
Chrona only handles navigation for its own layouts (e.g. sidebar).
...
In addition, the [`chrona-core/dynamic-link`](/docs/headless/components/link#dynamic-hrefs) component supports dynamic hrefs, you can use it to attend the locale prefix.
It is useful for Markdown/MDX content.

```mdx title="content.mdx"
import { DynamicLink } from 'chrona-core/dynamic-link';
