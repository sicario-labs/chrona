---
title: Next.js
description: Support i18n routing on your Next.js + Chrona app
---
...
import { RootProvider } from 'chrona-ui/provider/next';
...
In addition, the [`chrona-core/dynamic-link`](/docs/headless/components/link#dynamic-hrefs) component supports dynamic hrefs, you can use it to prepend the locale prefix.
