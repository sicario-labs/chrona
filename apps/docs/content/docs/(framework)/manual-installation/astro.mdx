---
title: Astro
description: Setup Chrona on Astro with React islands.
---
...
Chrona UI is a React library. On Astro, render it inside a React island and pass the current route information from your `.astro` page.

### Installation

```npm
npm i chrona-core chrona-ui @astrojs/react @astrojs/mdx @astrojs/markdown-remark react react-dom takumi-js sharp
```
...
Create a Chrona source from Astro content collections:

```ts title="src/lib/source.ts"
import type { StaticSource } from 'chrona-core/source';
import { loader } from 'chrona-core/source';
import { type CollectionEntry, getCollection } from 'astro:content';
import * as path from 'node:path';
import { structure, type StructuredData } from 'chrona-core/mdx-plugins';
...
Create the React island that renders Chrona UI:

```tsx tab="src/components/docs.tsx"
import { DocsLayout } from 'chrona-ui/layouts/docs';
import { DocsPage, type DocsPageProps } from 'chrona-ui/layouts/docs/page';
import type { Root } from 'chrona-core/page-tree';
import type { ReactNode } from 'react';
import { navigate } from 'astro:transitions/client';
import { RootProvider } from 'chrona-ui/provider/astro';
...
import { generate as DefaultImage } from 'chrona-ui/og/takumi';
