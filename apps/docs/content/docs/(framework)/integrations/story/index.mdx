...
You can use Chrona Story to display & document components.
...
Chrona Story is not a replacement for Storybook, we still recommend Storybook for proper UI testing.
...
import { storyTranslations } from '@chrona/story/i18n';
