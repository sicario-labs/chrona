---
title: Vite
description: Configure Chrona Story for Vite-based frameworks.
---
...
/* [!code ++] */
@import '@chrona/story/css/preset.css';
```
...
import story from '@chrona/story/vite';
...
import { defineStoryFactory } from '@chrona/story/vite/client';
