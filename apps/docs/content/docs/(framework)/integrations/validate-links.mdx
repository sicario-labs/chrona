...
> This guide is mainly for **Chrona MDX**, see the docs of `next-validate-link` for other setups.
...
To access the `source` object outside of app runtime, configure [Chrona MDX Loader](/docs/mdx/loader/bun) for Bun.
...
You might need to configure TypeScript transpiling (or newer version of Node.js), and [Chrona MDX Loader](/docs/mdx/loader/node).
