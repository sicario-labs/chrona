...
description: Build your own content source for Chrona.
---
...
```tsx
import { DocsPage, DocsBody } from 'chrona-ui/layouts/docs/page';
...
Chrona offers a variant of [Search Integrations](/docs/headless/search).
