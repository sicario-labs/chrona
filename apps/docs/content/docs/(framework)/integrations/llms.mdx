---
title: AI & LLMs
description: Integrate AI functionality to Chrona.
---
...
import { rewritePath } from 'chrona-core/negotiation';
...
```npm
npx @chrona/cli add ai/page-actions
```
...
You can install the AI chat dialog using Chrona CLI.

<Tabs items={['AI SDK', 'LLMGateway', 'Inkeep AI']}>
<Tab>

```npm
npx @chrona/cli add ai/openrouter
```
...
> Chrona doesn't provide the AI model, it's up to you.
>
...
```npm
npx @chrona/cli add ai/llmgateway
```
