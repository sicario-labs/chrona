...
Chrona OpenAPI uses a `<OpenAPIPage />` component to render page contents, it should be a client component.
...
} from 'chrona-openapi/requests/generators';
import { registerDefault } from 'chrona-openapi/requests/generators/all';
...
'use client';
import { createOpenAPIPage } from 'chrona-openapi/ui';
import type { MediaAdapter } from 'chrona-openapi';
