...
Chrona AsyncAPI uses a `<AsyncAPIPage />` component to render page contents, it should be a client component.
...
import { asyncapiTranslations } from '@chrona/asyncapi/i18n';
