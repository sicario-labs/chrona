...
Chrona GraphQL uses a `<GraphQLPage />` component to render page contents, it should be a client component.
...
import { graphqlTranslations } from '@chrona/graphql/i18n';
