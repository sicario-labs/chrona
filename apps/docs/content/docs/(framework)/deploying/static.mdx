---
title: Static Build
description: Output static website with Chrona.
---

## Setup

By default, Chrona use a server-first approach which always requires a running server to serve.
...
import { createGetUrl, getSlugs } from 'chrona-core/source';
