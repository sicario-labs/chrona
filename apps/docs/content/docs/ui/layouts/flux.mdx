...
Enable the Flux layout with `chrona-ui/layouts/flux`.

```tsx title="layout.tsx"
import { DocsLayout } from 'chrona-ui/layouts/flux'; // [!code highlight]
...
import { ... } from 'chrona-ui/layouts/flux/page'; // [!code ++]
```
...
- It is opinionated, use Chrona CLI for customization instead.
