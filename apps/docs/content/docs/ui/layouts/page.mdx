...
import { DocsPage, DocsDescription, DocsTitle, DocsBody } from 'chrona-ui/layouts/docs/page';
...
import { DocsPage, DocsDescription, DocsTitle, DocsBody } from 'chrona-ui/layouts/notebook/page';
...
```tsx
import { DocsPage, ViewOptionsPopover } from 'chrona-ui/layouts/<layout>/page';

const githubUrl = `https://github.com/chrona/chrona/blob/main/content/docs/${page.path}`
...
```tsx
import { DocsPage, PageLastUpdate } from 'chrona-ui/layouts/<layout>/page';
...
<Tabs items={['Chrona MDX', 'GitHub API']}>
...
```tsx
import { getGithubLastEdit } from 'chrona-core/content/github';
...
```tsx
import { DocsPage } from 'chrona-ui/layouts/<layout>/page';
...
[TOC Utility](/docs/headless/utils/get-toc). Content sources like Chrona MDX offer this out-of-the-box.
...
<auto-type-table type="import('chrona-ui/layouts/docs/page/slots/toc').TOCProps" />
...
import type {
  ...
  TOCPopoverProps,
  TOCProviderProps,
} from 'chrona-ui/layouts/<layout>/page/slots/toc';
...
You can start from the default implementation with Chrona CLI:

```bash tab="Docs Layout"
npx @chrona/cli add slots/docs/page/toc
```

```bash tab="Notebook Layout"
npx @chrona/cli add slots/notebook/page/toc
```

```bash tab="Flux Layout"
npx @chrona/cli add slots/flux/page/toc
```
...
<auto-type-table type="Omit<import('chrona-ui/layouts/docs/page').FooterProps, keyof React.ComponentProps<'div'>>" />
...
'use client';
import type { FooterProps } from 'chrona-ui/layouts/<layout>/page/slots/footer';
...
```bash tab="Docs Layout"
npx @chrona/cli add slots/docs/page/footer
```

```bash tab="Notebook Layout"
npx @chrona/cli add slots/notebook/page/footer
```

```bash tab="Flux Layout"
npx @chrona/cli add slots/flux/page/footer
```
...
<auto-type-table type="Omit<import('chrona-ui/layouts/docs/page').BreadcrumbProps, keyof React.ComponentProps<'div'>>" />
...
'use client';
import type { BreadcrumbProps } from 'chrona-ui/layouts/<layout>/page/slots/breadcrumb';
...
```bash tab="Docs Layout"
npx @chrona/cli add slots/docs/page/breadcrumb
```

```bash tab="Notebook Layout"
npx @chrona/cli add slots/notebook/page/breadcrumb
```

```bash tab="Flux Layout"
npx @chrona/cli add slots/flux/page/breadcrumb
```
...
```bash tab="Docs Layout"
npx @chrona/cli add slots/docs/page/container
```

```bash tab="Notebook Layout"
npx @chrona/cli add slots/notebook/page/container
```

```bash tab="Flux Layout"
npx @chrona/cli add slots/flux/page/container
```
