...
Enable the Glass layout with `chrona-ui/layouts/glass`.

```tsx title="layout.tsx"
import { GlassLayout } from 'chrona-ui/layouts/glass'; // [!code highlight]
...
```tsx title="page.tsx"
import { ... } from 'chrona-ui/layouts/docs/page'; // [!code --]
import { ... } from 'chrona-ui/layouts/glass/page'; // [!code ++]
```
...
@import 'tailwindcss';
/* [!code ++] */
@import 'chrona-ui/css/generated/glass.css';
...
- It is opinionated: the sidebar and header are more fixed than the default layout, use Chrona CLI or the `slots` option for customization.
...
```tsx title="layout.tsx"
import { GlassLayout } from 'chrona-ui/layouts/glass';
import { baseOptions } from '@/lib/layout.shared';
import { source } from '@/lib/source';
import type { ReactNode } from 'react';
