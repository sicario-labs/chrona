...
import { Heading } from 'chrona-ui/components/heading';
import { Card } from 'chrona-ui/components/card';
...
import { Step, Steps } from 'chrona-ui/components/steps';
import { TypeTable } from 'chrona-ui/components/type-table';
import { type ReactNode } from 'react';
import { Wrapper } from './wrapper';
import { GithubInfo } from 'chrona-ui/components/github-info';
...
export function accordion(): ReactNode {
  return (
    <Wrapper>
      <Accordions>
        <Accordion id="what-is-fumadocs" title="What is Chrona?">
    ...
    <Wrapper>
      <div className="flex flex-col gap-4">
        <Banner className="z-0" changeLayout={false}>
          Be careful, Chrona v99 has released
        </Banner>
