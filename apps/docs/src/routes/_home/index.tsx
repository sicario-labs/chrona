    ...
    <main className="text-landing-foreground pt-4 pb-6 dark:text-landing-foreground-dark md:pb-12">
      <div className="relative flex min-h-[600px] h-[70vh] max-h-[900px] border rounded-2xl overflow-hidden mx-auto w-full max-w-[1400px] bg-origin-border">
        ...
        <div className="flex flex-col z-2 px-4 size-full md:p-12 max-md:items-center max-md:text-center">
          ...
          <div className="flex flex-row items-center justify-center gap-4 flex-wrap w-fit">
            ...
            <a
              href="https://stackblitz.com/github/chrona/chrona/tree/main/examples/stackblitz"
              target="_blank"
      ...
      <div className="grid grid-cols-1 gap-10 mt-12 px-6 mx-auto w-full max-w-[1400px] md:px-12 lg:grid-cols-2 lg:mt-20">
        <p className="text-2xl tracking-tight leading-snug font-light col-span-full md:text-3xl xl:text-4xl">
          Chrona is a <span className="text-brand font-medium">React.js</span> documentation
  ...
  return (
    <>
      ...
      <div className={cn(cardVariants({ className: 'flex flex-col' }))}>
        ...
        <p className="mb-8">
          Want to use Chrona without the complexity of configurations & prior knowledge?
          <br />
          <br />
          Fumapress is a React.js framework for Chrona, every feature needs only a plugin –
          embracing simplicity fully for those who just want a working docs.
        </p>
        <div className="flex flex-row items-center gap-2">
          <a
            href="https://press.chrona.dev"
            rel="noreferrer noopener"
            target="_blank"
          ...
          <a
            href="https://press.chrona.dev/blog/introducing-fumapress"
            rel="noreferrer noopener"
            target="_blank"
...
Chrona fixes this by giving you all the right blocks that you compose together.
...
Like headless docs to build exactly what you need.`,
  ...
  },
  {
    ...
    message: 'chrona is the best Next.js docs framework',
  },
  {
  ...
  return (
    <>
      <div className={cn(cardVariants())}>
        ...
        <a href="/showcase" className={cn(buttonVariants())}>
          Showcase
        </a>
      </div>
      <div
    ...
    <>
      ...
      >
        ...
        <p className="mb-8">
          ...
          offering the high composability that engineers love — you can use Chrona as a library,
        ...
        <div className="mt-auto flex flex-col gap-2 @container mask-[linear-gradient(to_bottom,white,transparent)]">
          {[
            ...
            {
              name: 'chrona-openapi',
              description: 'Extend Chrona to render OpenAPI docs.',
            },
            {
              name: 'chrona-obsidian',
              description: 'Extend Chrona to handle Obsidian-style Markdown.',
            },
          ].map((item) => (
            <div
              key={item.name}
      ...
      <div className={cn(cardVariants())}>
        ...
        <p className="mb-4">
          ...
          Chrona works on MDX, Content Collections, and even your own CMS.
        </p>
        <div className="flex flex-row w-fit items-center gap-4 mb-6">
          {[
            {
              href: 'https://github.com/fuma-nama/chrona-basehub',
              text: 'BaseHub CMS',
            },
            {
              href: 'https://github.com/fuma-nama/chrona-sanity',
              text: 'Sanity',
            },
            {
              href: 'https://github.com/MFarabi619/chrona-payloadcms',
              text: 'Payload CMS',
            },
          ].map((item) => (
            <a
...
This is my first document.`}
      ...
      <div className={cn(cardVariants(), 'flex flex-col p-0 overflow-hidden')}>
        <div className="p-6 mb-2">
          ...
          <p className="mb-6">
            Chrona CLI creates interactive components for your docs, offering a rich experience to
            your users.
          </p>
          <a href="/docs/ui/components/codeblock" className={cn(buttonVariants({ className: 'w-fit' }))}>
            Commands
          </a>
        </div>
  ...
  return (
    <>
      ...
      <div className={cn(cardVariants({ className: 'flex flex-col' }))}>
        ...
        <p className="mb-8">Chrona is 100% powered by passion and open source community.</p>
        <div className="mb-8 flex flex-row items-center gap-2">
          ...
          <a
            href="https://github.com/chrona/chrona/tree/main/examples"
            rel="noreferrer noopener"
            className={cn(buttonVariants({ variant: 'secondary' }))}
          >
            Contributors
      ...
      >
        ...
        <li className="flex flex-row flex-wrap gap-2 mt-auto">
          ...
          <a href="https://github.com/chrona/chrona"
            rel="noreferrer noopener"
            className={cn(
              buttonVariants({
                variant: 'secondary',
