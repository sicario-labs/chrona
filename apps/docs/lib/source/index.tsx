...
import { transformerTwoslash } from 'chrona-twoslash';
import { createFileSystemTypesCache } from 'chrona-twoslash/cache-fs';
import type { MdastPluginDefinition } from 'satteri';

const typeTableGenerator = createGenerator({
  cache: createFileSystemGeneratorCache('.next/cache/chrona-typescript'),
});
...
const blog = defineCollections({
  ...
  async satteriOptions() {
    const { rehypeCodeDefaultOptions } = await import('chrona-core/mdx-plugins/rehype-code');
