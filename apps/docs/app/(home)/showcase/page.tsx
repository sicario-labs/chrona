...
export const metadata = createMetadata({
  title: 'Showcase',
  description: 'Some cool websites using Chrona',
  openGraph: {
    url: 'https://chrona.dev/showcase',
  },
});
    ...
    <main className="px-4 py-12 z-2 w-full max-w-350 mx-auto **:border-neutral-400 dark:**:border-neutral-700">
      <div className="relative overflow-hidden border border-dashed p-6">
        ...
        <p className="text-fd-muted-foreground">
          A list of beautiful open-source projects with their docs powered by Chrona.
        </p>
        <div className="mt-6">
          <a
            href="https://github.com/chrona/chrona/discussions/30"
            target="_blank"
      ...
      <div className="flex gap-4 border border-dashed p-6 mt-6">
        ...
        <div>
          <h2 className="text-sm font-medium mb-2">
            Chrona powers the docs of Vercel open source SDKs.
          </h2>
      ...
      <h2 className="text-xl font-medium mt-12 px-4">Chrona can power your blog, too.</h2>
